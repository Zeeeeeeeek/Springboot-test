...
public class RestTemplateConfig {
    ...
    public HttpClient httpClient() throws KeyStoreException, NoSuchAlgorithmException, KeyManagementException {
        ...
        SSLContextBuilder sslContextBuilder = new SSLContextBuilder().loadTrustMaterial((x509Certificates, s) -> true);
        ...
        RequestConfig requestConfig = RequestConfig.custom()
                ...
                .setConnectionRequestTimeout(
                        1000)//从连接池中获取连接的超时时间，超过该时间未拿到可用连接，会抛出org.apache.http.conn.ConnectionPoolTimeoutException: Timeout waiting for connection from pool
                .build();
